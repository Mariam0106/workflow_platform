...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $ceo = User::factory()->create([
            ...
            'default_application_role_id' => $roleAdmin->id,
            'manager_id' => null,
            'first_name' => 'Amina',
            'last_name' => 'Benali',
        ...
        // BR-06 (multi-role) : Karim est a la fois Validateur (son
        // usage quotidien - approuve les Requests Finance/Compliance)
        ...
        $financeManager = User::factory()->create([
            ...
            'default_application_role_id' => $roleValidator->id,
            'manager_id' => $ceo->id,
            'first_name' => 'Karim',
            'last_name' => 'Idrissi',
            'email' => 'karim.idrissi@saint-gobain.com',
        ]);
        $financeManager->applicationRoles()->syncWithoutDetaching([$roleAdmin->id]);

        $employee = User::factory()->create([
            'entity_id' => $hq->id,
            'department_id' => $itDept->id,
            'business_function_id' => $fnCommercial->id,
            'default_application_role_id' => $roleUser->id,
        ...
        Notification::factory()->sent()->create([
            ...
            'title' => 'Nouvelle demande en attente de votre approbation',
            'message' => "La demande {$submittedRequest->reference_number} nécessite votre validation.",
        ...
        Notification::factory()->sent()->create([
            ...
            'message' => "La demande {$completedRequest->reference_number} a été validée à toutes les étapes.",
        ...
        Notification::factory()->failed()->create([
            ...
            'title' => 'Contrôle de conformité requis',
            'message' => "La demande {$completedRequest->reference_number} nécessite un contrôle de conformité avant clôture.",
            'channel' => NotificationChannel::Email,
        ]);
