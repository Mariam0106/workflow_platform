...
return new class extends Migration
{
     ...
     *   libre "1.0" : nécessaire pour trier/incrementer les versions
     *   d'un même workflow (BR-24).
     ...
     *   (BR-56/57) - le cast PHP (Enum) sera ajoute a l'Étape 1.
     * - "code" n'est plus globalement unique : plusieurs versions du
     *   MEME workflow doivent pouvoir partager le même code. La
