...
use App\Http\Middleware\SetActiveApplicationRole;
...
return Application::configure(basePath: dirname(__DIR__))
    ...
    ->withMiddleware(function (Middleware $middleware): void {
        // BR-06 : garde la session à jour vis-à-vis du Rôle Applicatif
        // actif de l'Utilisateur - doit tourner après que la session/
        // l'authentification web soient disponibles, donc ajouté au
        // groupe 'web' plutôt qu'en global middleware.
        $middleware->web(append: [
            SetActiveApplicationRole::class,
        ]);
    })
