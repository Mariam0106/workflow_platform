...
@switch($name ?? '')
    ...
    @case('settings')
        ...
        @break
    @case('plus')
        <svg viewBox="0 0 18 18" fill="none" class="{{ $class ?? '' }}"><path d="M9 3.5v11M3.5 9h11" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg>
        @break
    @case('edit')
        <svg viewBox="0 0 18 18" fill="none" class="{{ $class ?? '' }}"><path d="M11.5 2.8l3.7 3.7-8.7 8.7-4.3.6.6-4.3 8.7-8.7z" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"/></svg>
        @break
    @case('archive')
        <svg viewBox="0 0 18 18" fill="none" class="{{ $class ?? '' }}"><rect x="2.5" y="3" width="13" height="3.2" rx="0.6" stroke="currentColor" stroke-width="1.5"/><path d="M3.5 6.5v7a1 1 0 001 1h9a1 1 0 001-1v-7" stroke="currentColor" stroke-width="1.5"/><path d="M7.3 9.7h3.4" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg>
        @break
    @case('restore')
        <svg viewBox="0 0 18 18" fill="none" class="{{ $class ?? '' }}"><path d="M3 5.5A6 6 0 119 15" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/><path d="M3 2.5v3.4h3.4" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
        @break
    @case('search')
        <svg viewBox="0 0 18 18" fill="none" class="{{ $class ?? '' }}"><circle cx="8" cy="8" r="5" stroke="currentColor" stroke-width="1.5"/><path d="M15 15l-3.4-3.4" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg>
        @break
    @case('arrow-left')
        <svg viewBox="0 0 18 18" fill="none" class="{{ $class ?? '' }}"><path d="M15 9H3M3 9l5-5M3 9l5 5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
        @break
    @case('mail')
        <svg viewBox="0 0 18 18" fill="none" class="{{ $class ?? '' }}"><rect x="2.5" y="4" width="13" height="10" rx="1" stroke="currentColor" stroke-width="1.5"/><path d="M3 5l6 4.5L15 5" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"/></svg>
        @break
    @case('phone')
        <svg viewBox="0 0 18 18" fill="none" class="{{ $class ?? '' }}"><path d="M4 2.5h2.2l1 3-1.4 1.3a8 8 0 004.4 4.4l1.3-1.4 3 1v2.2a1 1 0 01-1.1 1A11.5 11.5 0 013 3.6 1 1 0 014 2.5z" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"/></svg>
        @break
    @case('chevron-down')
        <svg viewBox="0 0 18 18" fill="none" class="{{ $class ?? '' }}"><path d="M4.5 7l4.5 4.5L13.5 7" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
        @break
    @case('shield')
        <svg viewBox="0 0 18 18" fill="none" class="{{ $class ?? '' }}"><path d="M9 2.3l5.5 2v3.5c0 4-2.4 6.7-5.5 7.9-3.1-1.2-5.5-3.9-5.5-7.9V4.3L9 2.3z" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"/><path d="M6.3 9l1.9 1.9L11.9 7" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
        @break
    @case('close')
        <svg viewBox="0 0 18 18" fill="none" class="{{ $class ?? '' }}"><path d="M4.5 4.5l9 9M13.5 4.5l-9 9" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg>
        @break
    @case('alert')
        <svg viewBox="0 0 18 18" fill="none" class="{{ $class ?? '' }}"><path d="M9 2.5l7.2 12.5a1 1 0 01-.87 1.5H2.67a1 1 0 01-.87-1.5L9 2.5z" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"/><path d="M9 7.2v3.3M9 12.8h.01" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg>
        @break
    @case('switch')
        <svg viewBox="0 0 18 18" fill="none" class="{{ $class ?? '' }}"><path d="M3 6h9M9 6L6.5 3.5M9 6L6.5 8.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M15 12H6M9 12l2.5 2.5M9 12l2.5-2.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
        @break
    @case('trash')
        <svg viewBox="0 0 18 18" fill="none" class="{{ $class ?? '' }}"><path d="M3.5 5h11M7 5V3.5a1 1 0 011-1h2a1 1 0 011 1V5m-6.5 0l.6 9a1 1 0 001 .9h4.8a1 1 0 001-.9l.6-9" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
        @break
    @case('logout')
        <svg viewBox="0 0 18 18" fill="none" class="{{ $class ?? '' }}"><path d="M7 15.5H4a1 1 0 01-1-1v-11a1 1 0 011-1h3" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M12 12.5l3.5-3.5-3.5-3.5M15.5 9H6.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
        @break
@endswitch
