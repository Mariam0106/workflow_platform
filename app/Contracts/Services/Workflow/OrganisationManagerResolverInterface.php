 ...
 * Department / cette Entity" pour les stratégies de validateur
 ...
 * jamais l'inverse) et aux règles de repartition de l'equipe, c'est le
 * domaine WORKFLOW qui definit ce contrat (il en a besoin), et c'est le
 * domaine ORGANISATION qui devra fournir l'implémentation réelle (par
 * exemple, si un jour departments/entities recoivent une colonne
 * "manager_id", ou toute autre logique metier decidee par le collègue).
 *
 * En attendant cette implémentation réelle, un binding temporaire
 ...
 * stratégies) plutôt que de planter.
 * ==========================================================================
 */
