...
class WorkflowPolicy
{
    ...
    /**
     * BR-54 : la suppression definitive (hors soft-delete) reste
     * reservee aux Administrateurs et interdite sur un Workflow publie.
     * La verification "ce Workflow est-il encore reference par des
     * Requests existantes" releve du Service (integrite des donnees),
     * pas de cette Policy (autorisation de l'acteur).
     */
