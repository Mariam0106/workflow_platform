...
final readonly class SubmitRequestData
{
    ...
    public function __construct(
        ...
        public array $values,
        public \App\Enums\FormPriority $priority = \App\Enums\FormPriority::Normal,
    ) {
        if ($this->values === []) {
    ...
    /**
     * @param  array{form_id: int, requester_id: int, values: array<int, string>, priority?: string}  $data
     */
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            values: $data['values'] ?? [],
            priority: isset($data['priority']) ? \App\Enums\FormPriority::from($data['priority']) : \App\Enums\FormPriority::Normal,
        );
    }
    ...
    /**
     * @return array{form_id: int, requester_id: int, values: array<int, string>, priority: string}
     */
