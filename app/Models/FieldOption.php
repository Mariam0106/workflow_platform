...
class FieldOption extends Model
{
    ...
    /**
     * Valeur réservée qui marque UNE option d'une liste comme "libre" -
     * l'Utilisateur qui remplit la Demande tape alors ce qu'il veut au
     * lieu de choisir parmi les valeurs prédéfinies (voir
     * my-requests/create.blade.php, qui bascule vers un champ texte dès
     * que cette valeur est sélectionnée). Une simple valeur réservée
     * plutôt qu'une colonne dédiée : reste une FieldOption tout à fait
     * normale pour le reste de l'application (comptage, réordonnancement,
     * suppression...), pas un cas à part.
     */
    public const FREE_TEXT_VALUE = '__AUTRE__';
    ...
    /**
     * Vrai pour l'option réservée "Autre" (voir FREE_TEXT_VALUE).
     */
    public function isFreeText(): bool
    {
        return $this->value === self::FREE_TEXT_VALUE;
    }
}