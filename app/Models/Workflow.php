...
class Workflow extends Model
{
    ...
    /**
     * Destinataires supplémentaires à notifier quand une Demande de ce
     * Workflow est entièrement approuvée (en plus du Demandeur).
     */
    public function completionNotifications(): HasMany
    {
        return $this->hasMany(WorkflowCompletionNotification::class);
    }
