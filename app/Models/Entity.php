...
class Entity extends Model
{
    ...
    /**
     * Responsable désigné de l'Entité - permet aux Étapes de Workflow
     * configurées en ENTITY_MANAGER de router vers un vrai Utilisateur
     * (voir OrganisationManagerResolver). Nullable : une Entité peut
     * exister sans Responsable désigné encore.
     */
