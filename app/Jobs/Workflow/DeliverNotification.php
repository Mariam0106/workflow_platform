 ...
 * (Etape 9) - separation deliberee : un Listener decide QUAND declencher
 * un envoi, un Job sait COMMENT le faire, avec ses propres tentatives/
 * delai de re-essai geres par la file d'attente Laravel elle-meme
 * (independamment de BR-47/attempt_count, qui suit les tentatives
...
class DeliverNotification implements ShouldQueue
{
    ...
    /**
     * Tentatives techniques de la Job elle-meme (re-essai reseau/
    ...
    public function handle(NotificationSenderInterface $sender): void
    {
        ...
        // La Notification a pu etre supprimee entre l'evenement et
