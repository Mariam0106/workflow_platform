    ...
    <div class="flex min-h-screen">
        ...
        <aside class="sidebar fixed inset-y-0 left-0 z-30 flex h-screen shrink-0 flex-col border-r border-brand-border bg-white">
            <div class="sidebar-logo-row flex items-center justify-between gap-2 border-b border-brand-border px-4 py-4">
                <a href="<?php echo e(route('dashboard')); ?>" title="Retour au tableau de bord" class="flex min-w-0 items-center gap-2.5 rounded-lg transition hover:opacity-80">
                    <span class="flex h-11 w-11 shrink-0 items-center justify-center overflow-hidden rounded-xl border border-brand-border bg-white shadow-sm">
                        <img src="<?php echo e(asset('images/saint-gobain-logo.jpg')); ?>" alt="Saint-Gobain" class="h-full w-full object-contain">
                    </span>
                ...
                <button type="button" onclick="toggleSidebar()" title="Réduire / agrandir le menu"
                    ...
                    <span class="sidebar-toggle-icon inline-flex transition-transform">
                        <?php echo $__env->make('layouts.partials.icon', ['name' => 'chevron-down', 'class' => 'h-4 w-4 -rotate-90'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    </span>
                </button>
            </div>
            ...
            <nav class="flex-1 space-y-6 overflow-y-auto px-3 py-5">
                ...
                <div>
                    <ul class="space-y-0.5">
                        <?php echo $__env->make('layouts.partials.nav-item', ['label' => 'Dashboard', 'route' => 'dashboard', 'icon' => 'dashboard'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

                        
                        <?php if($activeRoleCode === \App\Enums\ApplicationRoleCode::User): ?>
                            <?php echo $__env->make('layouts.partials.nav-item', ['label' => 'Nouvelle demande', 'route' => 'workflow.my-requests.select-form', 'icon' => 'plus'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            <?php echo $__env->make('layouts.partials.nav-item', ['label' => 'Mes demandes', 'route' => 'workflow.my-requests.index', 'routePattern' => 'workflow.my-requests.*', 'icon' => 'inbox'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        <?php endif; ?>

                        
                        <?php if($activeRoleCode === \App\Enums\ApplicationRoleCode::Validator): ?>
                            <?php echo $__env->make('layouts.partials.nav-item', ['label' => 'Mes validations', 'route' => 'workflow.my-validations.index', 'routePattern' => 'workflow.my-validations.*', 'icon' => 'check'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        <?php endif; ?>

                        <?php echo $__env->make('layouts.partials.nav-item', ['label' => 'Notifications', 'route' => 'workflow.notifications.index', 'routePattern' => 'workflow.notifications.*', 'icon' => 'bell'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    </ul>
                </div>
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('viewAny', \App\Models\User::class)): ?>
                    <div>
                        ...
                        <ul class="space-y-0.5">
                            <?php echo $__env->make('layouts.partials.nav-item', ['label' => 'Utilisateurs', 'route' => 'organisation.users.index', 'routePattern' => 'organisation.users.*', 'icon' => 'users'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            <?php echo $__env->make('layouts.partials.nav-item', ['label' => 'Départements', 'route' => 'organisation.departments.index', 'routePattern' => 'organisation.departments.*', 'icon' => 'building'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            <?php echo $__env->make('layouts.partials.nav-item', ['label' => 'Entités', 'route' => 'organisation.entities.index', 'routePattern' => 'organisation.entities.*', 'icon' => 'layers'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            <?php echo $__env->make('layouts.partials.nav-item', ['label' => 'Fonctions métier', 'route' => 'organisation.business-functions.index', 'routePattern' => 'organisation.business-functions.*', 'icon' => 'briefcase'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            <?php echo $__env->make('layouts.partials.nav-item', ['label' => 'Formulaires', 'route' => 'workflow.admin.forms.index', 'routePattern' => 'workflow.admin.forms.*', 'icon' => 'file'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            <?php echo $__env->make('layouts.partials.nav-item', ['label' => 'Workflow', 'route' => 'workflow.admin.workflows.index', 'routePattern' => 'workflow.admin.workflows.*', 'icon' => 'branch'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            <?php echo $__env->make('layouts.partials.nav-item', ['label' => 'Rapports', 'route' => 'workflow.admin.reports.index', 'icon' => 'chart'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            <?php echo $__env->make('layouts.partials.nav-item', ['label' => 'Historique', 'route' => 'workflow.admin.audit-logs.index', 'icon' => 'clock'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        </ul>
                    </div>
                <?php endif; ?>
            </nav>
            ...
            <div class="border-t border-brand-border p-3">
                <form method="POST" action="<?php echo e(route('logout')); ?>">
                    ...
                    <button type="submit" title="Se déconnecter"
                        ...
                        <?php echo $__env->make('layouts.partials.icon', ['name' => 'logout', 'class' => 'h-[18px] w-[18px] shrink-0'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        ...
        <div class="content-area flex-1">
            ...
            <header class="flex h-14 items-center justify-between gap-4 border-b border-brand-border bg-white px-6">
                <?php echo $__env->make('layouts.partials.app-search', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

                <div class="flex shrink-0 items-center gap-3">
                
                <?php if(auth()->user()->applicationRoles->count() > 1): ?>
                    <details class="role-switch relative">
                        <summary class="flex h-9 cursor-pointer list-none items-center gap-2 rounded-full border border-brand-border bg-slate-50 px-3.5 text-[13px] font-medium text-brand-navy transition hover:border-brand-blue/40 hover:bg-white [&::-webkit-details-marker]:hidden">
                            <?php echo $__env->make('layouts.partials.icon', ['name' => 'switch', 'class' => 'h-3.5 w-3.5 text-brand-blue'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            <?php echo e($activeRole?->name); ?>

                            <?php echo $__env->make('layouts.partials.icon', ['name' => 'chevron-down', 'class' => 'h-3.5 w-3.5 text-slate-400'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        </summary>
                        <div class="absolute right-0 z-20 mt-2 w-52 rounded-xl border border-brand-border bg-white p-1.5 shadow-lg">
                            ...
                            <?php $__currentLoopData = auth()->user()->applicationRoles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php $isCurrentRole = auth()->user()->activeApplicationRole()?->id === $role->id; ?>
                                <form method="POST" action="<?php echo e(route('active-role.update')); ?>">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('PUT'); ?>
                                    <input type="hidden" name="application_role_id" value="<?php echo e($role->id); ?>">
                                    <button type="submit"
                                            class="flex w-full items-center gap-2.5 rounded-lg px-2.5 py-2 text-left text-[13px] transition
                                                   <?php echo e($isCurrentRole ? 'bg-brand-blue/[0.06] font-medium text-brand-blue' : 'text-brand-navy hover:bg-slate-50'); ?>">
                                        <span class="flex-1"><?php echo e($role->name); ?></span>
                                        <?php if($isCurrentRole): ?>
                                            <?php echo $__env->make('layouts.partials.icon', ['name' => 'check', 'class' => 'h-4 w-4 shrink-0'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                        <?php endif; ?>
                                    </button>
                                </form>
                ...
                <?php
                    $unreadCount = \App\Models\Notification::query()
                        ...
                        ->count();
                ?>
                <a href="<?php echo e(route('workflow.notifications.index')); ?>" title="Notifications"
                   class="relative flex h-9 w-9 items-center justify-center rounded-full text-slate-500 transition hover:bg-slate-100 hover:text-brand-navy">
                    <?php echo $__env->make('layouts.partials.icon', ['name' => 'bell', 'class' => 'h-[18px] w-[18px]'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                ...
                <a href="<?php echo e(route('profile.show')); ?>" title="Mon profil"
                   class="flex h-9 w-9 items-center justify-center rounded-full bg-brand-blue text-xs font-semibold text-white ring-2 ring-transparent transition hover:ring-brand-blue/25">
                    <?php echo e(mb_substr(auth()->user()->first_name ?? '', 0, 1)); ?><?php echo e(mb_substr(auth()->user()->last_name ?? '', 0, 1)); ?>
    ...
    <?php if(session('status')): ?>
        ...
        >
            <span class="mt-0.5 flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-green-50 text-brand-success">
                <?php echo $__env->make('layouts.partials.icon', ['name' => 'check', 'class' => 'h-4 w-4'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </span>
            <p class="flex-1 pt-0.5"><?php echo e(session('status')); ?></p>
            <button type="button" onclick="document.getElementById('flash-toast').remove()"
                ...
                <?php echo $__env->make('layouts.partials.icon', ['name' => 'close', 'class' => 'h-4 w-4'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </button>
        </div>
        <style>
    ...
    <?php if($errors->any()): ?>
        ...
        >
            <span class="mt-0.5 flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-red-50 text-brand-danger">
                <?php echo $__env->make('layouts.partials.icon', ['name' => 'alert', 'class' => 'h-4 w-4'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </span>
            <p class="flex-1 pt-0.5"><?php echo e($errors->first()); ?></p>
...
</html><?php /**PATH C:\projects\to step 12 backup\resources\views/layouts/admin.blade.php ENDPATH**/ ?>