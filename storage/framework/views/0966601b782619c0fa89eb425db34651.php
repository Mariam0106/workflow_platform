<?php $__env->startSection('content'); ?>
    ...
    <p class="mt-7 text-center text-sm text-slate-500">
        ...
        <a href="<?php echo e(route('register')); ?>" class="font-medium text-brand-blue hover:text-brand-blue-dark hover:underline underline-offset-2">
            Créer un compte
        </a>
    </p>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.auth', ['title' => 'Connexion'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\projects\to step 12 backup\resources\views/auth/login.blade.php ENDPATH**/ ?>